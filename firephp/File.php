        ...
        switch ($ext) {
            ...
            default:
                if (function_exists($parse)) {
                    ...
                    //                    E('_NOT_SUPPORT_' . ':' . $ext);
                    // 没有相应的解析函数解析自定义的配置文件
                    Response::sendError(FireCode::ERR_CONF_PARSE, FIRE_MSG[FireCode::ERR_CONF_PARSE]);
                    exit;
                }
        }
    }
    ...
    public static function recursiveChmod($path, $filePerm = 0775, $dirPerm = 0775) {
        ...
        if (is_file($path)) {
            ...
            if ($status) {
                ...
                Response::sendError(FireCode::ERR_MAKE_DIR, FIRE_MSG[FireCode::ERR_MAKE_DIR]);
            }
...
//            chmod($path, $dirPerm);
            if ($status) {
                ...
                Response::sendException(FireCode::ERR_CHMOD_FAILED, FIRE_MSG[FireCode::ERR_CHMOD_FAILED], $output);
            }
        }
    ...
    public static function write($file, $content, $type = 'w') {
        try {
            ...
            Response::sendException(FireCode::ERR_FILE_WRITE, FIRE_MSG[FireCode::ERR_FILE_WRITE], $e);
        }
    }
    ...
    public static function makeDir($path, $dirPerm = 0) {
        ...
        try{
            ...
            Response::sendException(FireCode::ERR_MAKE_DIR, FIRE_MSG[FireCode::ERR_MAKE_DIR], $e->getMessage());
        }
        return false;
    }
}