...
// 版本信息
defined('fire_VERSION') or define('fire_VERSION', '1.0.0');
...
defined('FIRE_PATH') or define('FIRE_PATH', __DIR__ . DS);
defined('CORE_PATH') or define('CORE_PATH', realpath(FIRE_PATH . 'core') . DS); //系统目录
defined('CONF_PATH') or define('CONF_PATH', FIRE_PATH . 'conf' . DS); //定义配置目录
defined('DEFAULT_APP') or define('DEFAULT_APP', 'index'); //定义APP配置目录
defined('ORM_PATH') or define('ORM_PATH', FIRE_PATH . 'orm' . DS); //定义ORM目录
defined('EXTEND_PATH') or define('EXTEND_PATH', FIRE_PATH . 'extend' . DS); //自定义扩展类库目录
defined('VENDOR_PATH') or define('VENDOR_PATH', FIRE_PATH . 'vendor' . DS); //定义第三方扩展目录
...
require_once FIRE_PATH . 'Loader.php';
//自动注册
\fire\Loader::register();
